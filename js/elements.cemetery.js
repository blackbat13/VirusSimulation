// Transcrypt'ed from Python, 2020-05-21 20:31:04
...
var __name__ = 'elements.cemetery';
export var Cemetery =  __class__ ('Cemetery', [Container], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, settings, position, size, simulation) {
		__super__ (Cemetery, '__init__') (self, settings, position, size, simulation);
	});},
...
//# sourceMappingURL=elements.cemetery.map