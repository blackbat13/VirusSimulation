...
export var Settings =  __class__ ('Settings', [object], {
	...
	get _get_to_isolation_time () {return __get__ (this, function (self) {
...
Object.defineProperty (Settings, 'to_isolation_time', property.call (Settings, Settings._get_to_isolation_time));
