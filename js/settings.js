// Transcrypt'ed from Python, 2020-05-01 23:18:00
...
export var Settings =  __class__ ('Settings', [object], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		self.HUMAN_STATUS_COLOR = dict ([[HumanStatus.SICK, '#ff000d'], [HumanStatus.HEALTHY, '#39ff14'], [HumanStatus.CONTAGIOUS, '#ff0490'], [HumanStatus.RECOVERED, '#ccff00']]);
