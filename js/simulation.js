// Transcrypt'ed from Python, 2020-05-04 15:46:01
var random = {};
...
export var SimulationRandom =  __class__ ('SimulationRandom', [object], {
	...
	get add_sick () {return __get__ (this, function (self) {
		self._human_list.append (Human (self._settings, tuple ([random.randint (0, self._settings.WIDTH), random.randint (0, self._settings.HEIGHT)]), HumanStatus.SICK, false));
	});}
});
