...
export var Simulation =  __class__ ('Simulation', [object], {
	...
	get __init__ () {return __get__ (this, function (self) {
		...
		for (var _ = 0; _ < settings.HUMAN_COUNT; _++) {
			...
			self._human_list.append (Human (tuple ([random.randint (0, settings.WIDTH), random.randint (0, settings.HEIGHT)]), status, random.random () < settings.HUMAN_STATIONARY_PROBABILITY));
		}
	});},
